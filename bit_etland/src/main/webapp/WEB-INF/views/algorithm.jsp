...
<head>
  ...
  <script src="${js}/algorithm/algo.js"></script>
  <style>
    ...
    <div id="right_content" class="col-sm-9">
      ...
      <div class="row">
        <div class="col-sm-2 text-center">
          <img src="resources/img/bandmember.jpg" class="img-circle" height="65" width="65" alt="Avatar">
        </div>
        <div class="col-sm-10">
        ...
        <div class="col-sm-2 text-center">
          <img src="resources/img/bird.jpg" class="img-circle" height="65" width="65" alt="Avatar">
        </div>
        <div class="col-sm-10">
