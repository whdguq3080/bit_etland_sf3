		...
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					...
					<h1 class="brand"><a href="index.html">BIT RETAIL</a></h1>
					<!-- navigation -->
					<nav class="pull-right nav-collapse collapse">
						<ul id="menu-main" class="nav">
							<li><a href="#" id="cust_login">로 그 인</a></li>
							<li><a title="team" href="#about">목차</a></li>
							<li><a title="services" href="#services">서비스</a></li>
							<li><a title="works" href="#works">상품</a></li>
							<li><a title="blog" href="#blog">게시판</a></li>
							<li><a title="contact" href="#contact">도움말</a></li>
							<li><a href="page.html">소개</a></li>
						</ul>
					</nav>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="span6">
					<div class="aligncenter">
						<img src="resources/img/icons/creativity.png" alt="" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="span2 offset1 flyIn">
					<div class="people">
						<img class="team-thumb img-circle" src="resources/img/team/img-1.jpg" alt="" />
						<h3>이종협</h3>
						<p>Art director</p>
					</div>
				</div>
				<div class="span2 flyIn">
					<div class="people">
						<img class="team-thumb img-circle" src="resources/img/team/img-2.jpg" alt="" />
						<h3>이창준</h3>
						<p>Web developer</p>
					</div>
				</div>
				<div class="span2 flyIn">
					<div class="people">
						<img class="team-thumb img-circle" src="resources/img/team/img-3.jpg" alt="" />
						<h3>김태혁</h3>
						<p>Web designer</p>
					</div>
				</div>
				<div class="span2 flyIn">
					<div class="people">
						<img class="team-thumb img-circle" src="resources/img/team/img-4.jpg" alt="" />
						<h3>남기호</h3>
						<p>UI designer</p>
					</div>
				</div>
				<div class="span2 flyIn">
					<div class="people">
						<img class="team-thumb img-circle" src="resources/img/team/img-5.jpg" alt="" />
						<h3>서동준</h3>
						<p>Digital imaging</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="span3 animated-fast flyIn">
					<div class="service-box">
						<img src="resources/img/icons/laptop.png" alt="" />
						<h2>Web design</h2>
						<p>
				...
				<div class="span3 animated flyIn">
					<div class="service-box">
						<img src="resources/img/icons/lab.png" alt="" />
				...
				<div class="span3 animated-fast flyIn">
					<div class="service-box">
						<img src="resources/img/icons/camera.png" alt="" />
						<h2>Photography</h2>
						<p>
							Lorem Ipsum is simply dummy text of the printing and typesetting industry.
						</p>
				...
				<div class="span3 animated-slow flyIn">
					<div class="service-box">
						<img src="resources/img/icons/basket.png" alt="" />
						<h2>Ecommerce</h2>
						<p>
							Lorem Ipsum is simply dummy text of the printing and typesetting industry.
						</p>
				...
				<div class="span12">
					<div id="portfolio-wrap">
						...
						<div class="portfolio-item grid print design web">
							<div class="portfolio">
								<a href="resources/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="resources/img/works/2.png" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
						...
						<div class="portfolio-item grid print design">
							<div class="portfolio">
								<a href="resources/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="resources/img/works/3.png" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
						...
						<div class="portfolio-item grid photography web">
							<div class="portfolio">
								<a href="resources/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="resources/img/works/5.png" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
						...
						<div class="portfolio-item grid photography web">
							<div class="portfolio">
								<a href="resources/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="resources/img/works/6.png" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
						...
						<div class="portfolio-item grid photography web">
							<div class="portfolio">
								<a href="resources/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="resources/img/works/7.png" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
						...
						<div class="portfolio-item grid photography">
							<div class="portfolio">
								<a href="resources/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="resources/img/works/8.png" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
						...
						<div class="portfolio-item grid photography web">
							<div class="portfolio">
								<a href="resources/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="resources/img/works/9.png" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
		...
		<div class="container">
			...
			<div class="row">
				<div class="span3">
					<div class="home-post">
						<div class="post-image">
							<img class="max-img" src="resources/img/blog/img1.jpg" alt="" />
						</div>
						<div class="post-meta">
				...
				<div class="span3">
					<div class="home-post">
						<div class="post-image">
							<img class="max-img" src="resources/img/blog/img2.jpg" alt="" />
						</div>
						<div class="post-meta">
							<i class="icon-file icon-2x"></i>
							<span class="date">June 19, 2013</span>
				...
				<div class="span3">
					<div class="home-post">
						<div class="post-image">
							<img class="max-img" src="resources/img/blog/img3.jpg" alt="" />
						</div>
						<div class="post-meta">
							<i class="icon-file icon-2x"></i>
				...
				<div class="span3">
					<div class="home-post">
						<div class="post-image">
							<img class="max-img" src="resources/img/blog/img4.jpg" alt="" />
						</div>
						<div class="post-meta">
							<i class="icon-file icon-2x"></i>
